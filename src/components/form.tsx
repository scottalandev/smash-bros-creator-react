...
function WeightInput() {
  ...
  return (
    <>
      ...
      <input type="range" id="weight" min="62" value={weight} max="135" onChange={handleChange} />
...
function FinalSmashInput() {
  return (
    <>
      ...
      <input type="text" id="finalSmash.name" />
      <br />
